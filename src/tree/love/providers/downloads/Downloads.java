...
public final class Downloads {
    ...
    public static final class Impl implements BaseColumns {
         ...
         */
        public static final String PERMISSION_ACCESS = "tree.love.android.permission.ACCESS_DOWNLOAD_MANAGER";

        /**
         * The permission to access the download manager's advanced functions
         */
        public static final String PERMISSION_ACCESS_ADVANCED =
                "tree.love.android.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

        /**
         * The permission to access the all the downloads in the manager.
         */
        public static final String PERMISSION_ACCESS_ALL =
                "tree.love.android.permission.ACCESS_ALL_DOWNLOADS";

        /**
         * The permission to directly access the download manager's cache
         * directory
         */
        public static final String PERMISSION_CACHE = "tree.love.android.permission.ACCESS_CACHE_FILESYSTEM";

        /**
         * The permission to send broadcasts on download completion
         */
        public static final String PERMISSION_SEND_INTENTS =
                "tree.love.android.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";
        ...
        public static final String PERMISSION_CACHE_NON_PURGEABLE =
                "tree.love.android.permission.DOWNLOAD_CACHE_NON_PURGEABLE";
        ...
        public static final String PERMISSION_NO_NOTIFICATION =
                "tree.love.android.permission.DOWNLOAD_WITHOUT_NOTIFICATION";

        /**
         * The content:// URI to access downloads owned by the caller's UID.
         */
        public static final Uri CONTENT_URI =
                Uri.parse(DownloadProvider.SCHEME + DownloadProvider.AUTHORITY + "/my_downloads");
        ...
        public static final Uri ALL_DOWNLOADS_CONTENT_URI =
                Uri.parse(DownloadProvider.SCHEME + DownloadProvider.AUTHORITY + "/all_downloads");
         ...
         */
        public static final Uri PUBLICLY_ACCESSIBLE_DOWNLOADS_URI = Uri.parse(DownloadProvider.SCHEME + DownloadProvider.AUTHORITY
