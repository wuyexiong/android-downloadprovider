...
import static tree.love.providers.downloads.Constants.TAG;
import static tree.love.providers.downloads.Downloads.Impl.STATUS_BAD_REQUEST;
import static tree.love.providers.downloads.Downloads.Impl.STATUS_CANNOT_RESUME;
import static tree.love.providers.downloads.Downloads.Impl.STATUS_FILE_ERROR;
import static tree.love.providers.downloads.Downloads.Impl.STATUS_HTTP_DATA_ERROR;
import static tree.love.providers.downloads.Downloads.Impl.STATUS_SUCCESS;
import static tree.love.providers.downloads.Downloads.Impl.STATUS_TOO_MANY_REDIRECTS;
import static tree.love.providers.downloads.Downloads.Impl.STATUS_WAITING_FOR_NETWORK;
import static tree.love.providers.downloads.Downloads.Impl.STATUS_WAITING_TO_RETRY;
...
import tree.love.providers.downloads.DownloadInfo.NetworkState;
...
//        public int mNetworkType = ConnectivityManager.TYPE_NONE;
    ...
    private static String normalizeMimeType(String type) {
        ...
        type = type.trim().toLowerCase(ROOT);
...
//            netPolicy.unregisterListener(mPolicyListener);
    ...
    // private INetworkPolicyListener mPolicyListener = new
    // INetworkPolicyListener.Stub() {
    // @Override
